package br.com.jwar.learntrail.data.di

import android.content.Context
import androidx.room.Room
import br.com.jwar.learntrail.data.datasources.local.database.LocalDataSource
import br.com.jwar.learntrail.data.datasources.local.database.room.APP_DATABASE_NAME
import br.com.jwar.learntrail.data.datasources.local.database.room.RoomAppDatabase
import br.com.jwar.learntrail.data.datasources.local.database.room.RoomLocalDataSource
import br.com.jwar.learntrail.data.datasources.local.preferences.Preferences
import br.com.jwar.learntrail.data.datasources.local.preferences.datastore.DataStorePreferences
import br.com.jwar.learntrail.data.datasources.remote.RemoteDataSource
import br.com.jwar.learntrail.data.datasources.remote.opentdb.OPEN_TDB_API_HOST
import br.com.jwar.learntrail.data.datasources.remote.opentdb.OpenTDBApi
import br.com.jwar.learntrail.data.datasources.remote.sample.SampleRemoteDataSource
import br.com.jwar.learntrail.data.repositories.ActivityRepositoryImpl
import br.com.jwar.learntrail.data.repositories.UnitRepositoryImpl
import br.com.jwar.learntrail.data.repositories.UserRepositoryImpl
import br.com.jwar.learntrail.data.services.translator.MLKitTranslatorService
import br.com.jwar.learntrail.data.services.translator.TranslatorService
import br.com.jwar.learntrail.data.utils.HtmlStringAdapter
